...
In this post I will stick to keeping apps away from the host fs, but please check out my [other post](/2017/09/08/the-route-to-rootless-containers) to learn more about process isolation
and security.
...
containers completely in [rootless mode](/2017/09/08/the-route-to-rootless-containers).
